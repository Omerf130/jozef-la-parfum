...
export const metadata: Metadata = {
  title: "אודות",
  description: `${SITE_NAME} — מותגים ומחירים של פעם בחיים, מקורי בלבד. כל מותגי הבישום תחת קורת גג אחת.`,
};
  ...
  return (
    <article className={styles.page}>
      ...
      <section className={styles.section}>
        <p>
          ב-{SITE_NAME}, המטרה שלנו היא פשוטה: להנגיש את עולם הבישום לכולם.
        ...
        <p>
          ...
          או נועז – ב-{SITE_NAME} אתם תמיד מקבלים את המקסימום במחיר המינימלי.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <FaqItem
          ...
          answer={
            <p>
               כן מקוריים , מייבאים את הבשמים שלנו מיבואן רישמי ומקביל .
            </p>
          }
        />
        <FaqItem
          ...
          answer={
            <p>
              ניתן להחזיר בושם עד 14 ימי עסקים כל עוד האריזה המקורית לא
              נפתחה ולא נעשה שימוש בבושם באחריותו האישית של הלקוח לספק החזר לבעל העסק ביצירת קשר.
        ...
        <FaqItem
          ...
          answer={<p> עד 7 ימי עסקים לא כולל שישי שבת וחגים.</p>}
        />
        <FaqItem
          question="מה עלויות המשלוח ?"
          answer={<p>{shippingPriceILS} שקלים למשלוח, משלוח חינם בקנייה מעל {freeShippingThreshold}.</p>}
        />
        <FaqItem
          question="האם בטוח לשלם אצלכם ?"
          answer={<p>כן בטח, התשלום אצלנו מאובטח ומתבצע דרך חברת pay plus.</p>}
        />
        <FaqItem
          question="האם יש לכם חנות פיזית שאפשר להגיע ולהתרשם ?"
          answer={<p>אנחנו כרגע אתר אונליין בלבד .</p>}
        />
        <FaqItem
          question="האם אפשר למצוא אצלכם בשמים שלא נמצאים באתר ?"
          answer={
            <p>
              כן , הלקוחות מוזמנים ליצור עימנו קשר לגבי בושם שלא באתר ,
        ...
        <FaqItem
          ...
          answer={
            <p>
              כמובן , תשלום מאובטח בכרטיס אשראי דרך חברת PAYPLUS . 
